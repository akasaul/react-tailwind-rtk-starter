    ...
    <div className='w-full'>
      ...
      <section className='border-b-[1px] p-2 mb-2 space-x-3 border-stroke flex'>
          ...
          <div className='flex-1 h-24 flex flex-col justify-center'>
            <input type="text" placeholder="What's happening?" className='w-32 sm:w-48 mb-6 text-[0.9rem] font-[400] bg-transparent' />
            <div className='flex items-center justify-between'>
              ...
              <button className='bg-primary px-3 rounded-full'>Tweet</button>
            </div>
          </div>
      </section>
      <Post />
